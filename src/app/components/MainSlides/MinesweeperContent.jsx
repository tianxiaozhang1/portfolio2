                ...
                <div className={`ml-4 ${selawkReg.className} items-center flex`}>
                    <div>
                        ...
                        <div className='flex space-x-2 font-medium pt-2 text-sm'>
                            ...
                            <Link target="_blank" href="https://minesweeper-pi-azure.vercel.app/" className={`hover:cursor-pointer`}>
                                <div className={`${theme === 'dark' ? ' ' : '' } rounded-sm text-stone-50 bg-[#27639b] hover:bg-[#2f77ba] text-start px-4 py-1 w-fit`}>JavaScript Version</div>
                            </Link>
                            <Link target="_blank" href="https://minesweeper-pi-azure.vercel.app/" className={`hover:cursor-pointer`}>
                                <div className={`${theme === 'dark' ? ' ' : '' } rounded-sm text-stone-50 bg-[#27639b] hover:bg-[#2f77ba] text-start px-4 py-1 w-fit`}>Python Version</div>
                            </Link>
                        </div>
                    </div>
                </div>
