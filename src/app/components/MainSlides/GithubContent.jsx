...
function GithubContent({ theme }) {
    ...
    return (
        <div className={`w-full h-full pt-0.5 ${selawkReg.className}`}>
            <div className='w-full h-full flex items-start space-x-2 pb-2'>
                <div className={`${theme==="dark" ? `bg-zinc-700` : 'bg-zinc-50'} h-fit w-52 rounded-lg flex justify-center items-start pt-4`}>
                    <div className='pb-4'>
                ...
                <div className='space-y-2 w-full pr-0'>
                    <div className={`${theme==="dark" ? `bg-zinc-700` : 'bg-zinc-50'} w-full border-1 rounded-lg h-38 text-start pt-2 pl-5 pr-3 ${theme==="dark" ? `border-stone-500 text-gray-300` : `border-stone-400 text-gray-600`}`}>
                        ...
                        <div className='flex flex-wrap mt-3 gap-2'>
                            ...
                            <div><Image src={TypescriptLogo} alt="Typescript Logo" className='h-10 w-10 rounded-md' /></div>
                            <div className={`bg-gray-50 h-10 w-10 rounded-md`}><Image src={NextjsLogo} alt="Nextjs Logo" className={``} /></div>
                            <div><Image src={NodejsLogo} alt="Nodejs Logo" className='h-10 w-10' /></div>
                            <div><Image src={NeonLogo} alt="Neon Logo" className='h-10 w-10' /></div>
                            ...
                            <div className='bg-white rounded-md'><Image src={DeepSeekLogo} alt="Firebase Logo" className='h-10 w-10' /></div>
                            <div className={`${theme==="dark" ? `bg-gray-50` : 'bg-gray-50' } rounded-md`}><Image src={RetoolLogo} alt="ChatGPT Logo" className='h-10 w-10' /></div>
                            <div className={`' } rounded-md`}><Image src={ZapierLogo} alt="Gemini Logo" className='h-10 w-10' /></div>
                            <div className={`${theme==="dark" ? `bg-gray-50` : 'bg-gray-50' } rounded-md h-10 w-10 `}><Image src={SquarespaceLogo} alt="Firebase Logo" className='h-9 w-9 m-auto mt-0.5' /></div>
                        </div>
                    </div>

                    <div className={`${theme==="dark" ? `bg-zinc-700` : 'bg-zinc-50'} w-full h-48 rounded-lg border-1 text-start py-3 pl-5 pr-3 ${theme==="dark" ? `border-stone-500 text-gray-300` : `border-stone-400 text-gray-600`}`}>
